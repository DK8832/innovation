(() => {
  ...
  const APK_URL = "https://github.com/DK8832/innovation/releases/download/v2.0.0/CERTI_ON_v2.0.0_ANDROID.apk";
  ...
  window.fetch = async function(input, options = {}) {
    ...
    if (api === "/api/app/android") return response({available:true,platform:"Android",version:"2.0.0",filename:"CERTI_ON_v2.0.0_ANDROID.apk",size_bytes:23584072,download_url:APK_URL});
